...
import ru.kggm.imagegallerytest.viewModels.*
import ru.kggm.imagegallerytest.views.adapters.FilesRecyclerAdapter
...
class FilesFragment : Fragment() {
    ...
    private fun onRefresh() {
        folderViewModel.scanFolders(requireContext(), listOf(".jpg"))
